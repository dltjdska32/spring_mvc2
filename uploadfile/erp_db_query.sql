...
CREATE TABLE IF NOT EXISTS `erp_db`.`position` (
  ...
  UNIQUE INDEX `position_num_UNIQUE` (`position_num` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `erp_db`.`dept` (
  ...
  UNIQUE INDEX `dept_num_UNIQUE` (`dept_num` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `erp_db`.`user` (
  ...
  INDEX `fk_user_position_idx` (`position_num` ASC) VISIBLE,
  INDEX `fk_user_dept1_idx` (`dept_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`leave_log` (
  ...
  UNIQUE INDEX `leave_num_UNIQUE` (`leave_num` ASC) VISIBLE,
  INDEX `fk_leave_log_user1_idx` (`user_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`mail_store` (
  ...
  UNIQUE INDEX `mail_num_UNIQUE` (`mail_store_num` ASC) VISIBLE,
  INDEX `fk_mail_store_user1_idx` (`user_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`work_log` (
  ...
  PRIMARY KEY (`log_num`),
  UNIQUE INDEX `log_num_UNIQUE` (`log_num` ASC) VISIBLE,
  INDEX `fk_work_log_user1_idx` (`user_num` ASC) VISIBLE,
  INDEX `fk_work_log_leave_log1_idx` (`leave_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`mail` (
  ...
  PRIMARY KEY (`mai_num`),
  UNIQUE INDEX `mai_num_UNIQUE` (`mai_num` ASC) VISIBLE,
  INDEX `fk_mail_mail_store1_idx` (`mail_store_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`received_mail` (
  ...
  UNIQUE INDEX `receive_num_UNIQUE` (`receive_num` ASC) VISIBLE,
  INDEX `fk_receive_mail_user1_idx` (`user_num` ASC) VISIBLE,
  INDEX `fk_receive_mail_mail1_idx` (`mail_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`board` (
  ...
  UNIQUE INDEX `board_num_UNIQUE` (`board_num` ASC) VISIBLE,
  INDEX `fk_board_user1_idx` (`user_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`board_answer` (
  ...
  UNIQUE INDEX `answer_num_UNIQUE` (`answer_num` ASC) VISIBLE,
  INDEX `fk_board_answer_board1_idx` (`board_num` ASC) VISIBLE,
  INDEX `fk_board_answer_user1_idx` (`user_num` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_db`.`salary_log` (
  ...
  UNIQUE INDEX `salary_num_UNIQUE` (`salary_num` ASC) VISIBLE,
  INDEX `fk_salary_log_user1_idx` (`user_num` ASC) VISIBLE,
